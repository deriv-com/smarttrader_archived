...
const DialogOverlay = forwardRef<ElementRef<typeof Overlay>, ComponentPropsWithoutRef<typeof Overlay>>(
    ({ className, ...props }, ref) => (
        <Overlay ref={ref} className={cn(twClasses.DialogOverlay, className)} {...props} />
    )
);
...
const DialogContent = forwardRef<ElementRef<typeof Content>, ComponentPropsWithoutRef<typeof Content>>(
    ({ className, children, ...props }, ref) => (
        <DialogPortal>
            <DialogOverlay />
            <Content ref={ref} className={cn(twClasses.DialogContent, className)} {...props}>
                {children}
                <Close className={twClasses.DialogClose}>
